...
const Dashboard = () => {
  return (
      <div className="min-h-screen bg-gradient-to-br from-purple-100 via-black-100 to-purple-300 p-8 backdrop-blur-lg shadow-1xl rounded-2xl p-8 border border-purple-100/50">
